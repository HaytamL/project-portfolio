  ...
  return (
    <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center">
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <Image aria-hidden src="/linkedin-big-logo.svg" alt="Window icon" width={16} height={16} />
          Linkedin
        </a>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/50">
          <div className="rounded-3xl shadow-2xl p-8 w-96 relative animate-zoomModal" style={{backgroundImage: 'url("/background.svg")', backgroundSize: "cover",backgroundPosition: "center",}}>
            ...
            <button onClick={() => setIsModalOpen(false)} className="absolute top-4 right-4 text-gray-500 hover:text-gray-800 text-2xl">
              fermer
            </button>
          </div>
        </div>
